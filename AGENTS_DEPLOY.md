...
- Build portable binaries for Linux (x86_64 musl, aarch64 musl), macOS
  (x86_64, aarch64), and Windows (x86_64)
- Build accelerator binaries for Linux x86_64 CUDA and Apple Silicon Metal
- Run archive acceptance procedures for all seven targets, including Metal
  backend execution and CUDA dynamic-library validation
